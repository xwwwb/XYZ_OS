...
| day5 | 已完成 2023-5-31 | 了解了结构体的内存分布和使用，新增的GDT和IDT部分很迷糊😫很晕...                      |
| day6 | 已完成 2023-5-31 | PIC也很迷糊，中断处理程序作用是保护CPU现场，结合day5 可以理解一点🤨很晕... |
| day7 | 已完成 2023-6-1 | 理解了FIFO先进先出的实现，将其应用在处理键盘和鼠标的中断处理中🥱相对于前两天好理解 |
